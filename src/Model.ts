...
export enum JUDGETYPE {
	undefined = -1,
	None,		// 0 无牛			牌型：五张牌中，任意3张牌的点数之和都不为10的整数倍
	Cattle_1,	// 1 牛1 			有牛牌型：5张牌中有3张牌的点数之和为10的整数倍，另外2张牌的点数之和mod（10）等于几，即为牛几
	Gold_1,		// 2 金牌牛			5张牌中有3张一样
	Cattle_2,	// 3 牛2
	Gold_2,		// 4 金牌牛			5张牌中有3张一样
	Cattle_3,	// 5 牛3
	Gold_3,		// 6 金牌牛			5张牌中有3张一样
	Cattle_4,	// 7 牛4
	Gold_4,		// 8 金牌牛			5张牌中有3张一样
	Cattle_5,	// 9 牛5
	Gold_5,		// 10 金牌牛		5张牌中有3张一样
	Cattle_6,	// 11 牛6
	Gold_6,		// 12 金牌牛		5张牌中有3张一样
	Cattle_7,	// 13 牛7
	Gold_7,		// 14 金牌牛		5张牌中有3张一样
	Cattle_8,	// 15
	Gold_8,		// 16 金牌牛		5张牌中有3张一样
	Cattle_9,	// 17 牛8
	Gold_9,		// 18 金牌牛		5张牌中有3张一样
	Double,		// 19 牛牛  		牌型：5张牌中有3张牌的点数之和为10的整数倍，并且，另外2张牌的点数之和为10的整数倍
	GoldDouble,	// 20 金牌牛牛		5张牌中有3张一样，且两张之和为10
	Sequence,	// 21 顺子			5张牌中的数字 为顺子（2，3，4，5，6）
	Gourd,		// 22 葫芦牛		5张牌的牌型为 AABBB （3张一样的牌加2张一样的牌）
	Ten,		// 23 十小			无花中5张牌的点数相加之和小于等于10
	Forty,		// 24 四十			无花中5张牌的点数相加之和大于或者等于40
	Bomb,		// 25 炸弹牛		5张牌中4张点数一样（ABBBB）
}
...
export const DAgents = 		db.collection<SchemaAgent>('agents');
